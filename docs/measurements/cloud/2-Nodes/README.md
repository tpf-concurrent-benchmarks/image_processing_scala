### 2 Nodes Measurements

#### Average Summary

- Combined Throughput: 75.3 Results/Second
- Max Work Time Variation: 4.3%
- Max Memory Usage: 330 MB/Worker
- Max Network Usage (Tx): 15 KB/(s * Worker)
- Max Network Usage (Rx): 11 KB/(s * Worker)
- CPU Usage (Format worker): 64%
- CPU Usage (Resolution worker): 37%
- CPU Usage (Size worker): 13%
- Completion Time: 19.9 Minutes
